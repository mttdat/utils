...
public class EditTextPlus extends AppCompatEditText {
    ...
    public EditTextPlus(Context context, AttributeSet attrs) {
        ...
        graphicHeight = a.getFloat(R.styleable.EditTextPlus_customGraphicHeight, 0f);
        graphicWidth = a.getFloat(R.styleable.EditTextPlus_customGraphicWidth, 0f);
        a.recycle();
    ...
    private void setCustomSize(Context ctx, AttributeSet attrs) {
        ...
        customSizePx = a.getFloat(R.styleable.EditTextPlus_customSizePx, 0f);
        customSizePt = a.getFloat(R.styleable.EditTextPlus_customSizePt, 0f);
